...
public class InformationAdapter {
    ...
    private final String insertImage = "https://mapacheproject.xyz/UCAnet/code/imageUpload.php";
   ...
   public boolean insertThread(String title, int courseId, String content,
    ...
    public boolean insertImage(String imageName, String image) throws IOException{
        URL url = new URL(insertImage);
        Map<String,Object> params = new LinkedHashMap<>();
        params.put("image", image);
